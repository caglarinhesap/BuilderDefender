...
public class HealthBar : MonoBehaviour
{
    ...
    private void ConstructHealthBarSeperators()
    {
        ...
        int maxHealth = healthSystem.GetHealthAmountMax();
        int healthAmountPerSeperator = 10;
        float barSize = 3f;
        float barOneHealthAmountSize = barSize / maxHealth;
        int healthSeperatorCount = Mathf.FloorToInt(maxHealth / healthAmountPerSeperator);
